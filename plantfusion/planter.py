...
class Planter:
    def __init__(
        ...
        # elif type == "row":
        # self.__row(plantmodels, plant_density, xy_square_length)
    ...
    def __random(self, plantmodels, plant_density, xy_square_length):
        ...
        nbplants = int(xy_square_length * xy_square_length * plant_density[1])

        if "legume" in plantmodels:
            # on réajuste le domaine pour avoir 64 plantes
            xy_square_length = math.sqrt(64/plant_density[1])
            self.domain = ((0.0, 0.0), (xy_square_length, xy_square_length))
            nbplants = 64
        ...
        if "wheat" in plantmodels:
            self.wheat_nbplants = nbplants
            self.wheat_positions = []

    # def __row(self, plantmodels, plant_density, xy_plane):
    ...
    def generate_random_wheat(self, adel_wheat, mtg, seed=None):
        ...
        if self.wheat_positions != [] and self.save_wheat_positions:
            ...
            positions = []
            for i in range(self.wheat_nbplants):
